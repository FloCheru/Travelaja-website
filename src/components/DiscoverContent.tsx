              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p className="text-gray-700 mb-4">
                    ...
                    Integer facilisis aliquet sed vitae. Vivamus ac vulputate
                    feugiat magna tristique orci, posuere fringilla nibh vitae
                    arcu. Elementum posuere non enim tempus vel vitae. Nibh
                    elementum feugiat id augue ut vulputate lorem lobortis
                    consequat fermentum.
                  </p>
                  <p className="text-gray-700">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Nibh diam et euismod et vulputate consectetur sed laoreet
                    lorem. Lorem egestas et augue lacus, viverra vitae congue
                    aut consequat elit. Amet, mi dolor pretium magna diam
                    vulputate commodo sed laoreet augue. Magna mi.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden mb-8">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  integer facilisis aliquet sed vitae viverra fermentum.
                  Placerat ursa integer nibh justo. Dictum vulputate odio mauris
                  amet, dictumst imperdiet. Faucibus consectetur mauris
                  tristique dolor id diam, adipiscing et. Semper mi proin
                  pretium cursus vel pretium. Consectetur posuere socius amet
                  sunt. Euismod turpis pellentesque sit risus eu, augue nulla.
                  Faucibus urna mi placerat sed.
                </p>
                <p className="text-gray-700">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet
                  integer facilisis aliquet sed vitae viverra fermentum.
                  Placerat ursa integer nibh justo. Dictum vulputate odio mauris
                  amet, dictumst imperdiet.
                </p>
                ...
                {[1, 2, 3].map((index) => (
                  <Card key={index} className="mb-4 overflow-hidden">
                    <div className="relative">
                      ...
                      <div className="absolute bottom-0 left-0 p-4 text-white">
                        <h4 className="font-bold text-lg">
                          Wakatobi Beach Is A Paradise For Coral Reefs in
                          Indonesia
                        </h4>
                    ...
                    <CardContent className="p-4 flex justify-end">
                      <a
                        href="#"
                        className="bg-green-500 text-white text-sm px-4 py-2 rounded hover:bg-green-600 transition-colors"
                      >
                        View More
                      </a>
                    </CardContent>
