    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="container mx-auto py-12 px-4 md:px-8">
        ...
        <p className="text-center text-gray-600 mb-10">
          Travel with like-minded travelers from all over the globe
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center text-center p-6">
            ...
            <p className="text-gray-600">
              Find a lower price and we'll match it plus give you an additional
              discount.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6">
            ...
            <p className="text-gray-600">
              Search, select and book your bus tickets with instant
              confirmation.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-3/5">
            <p className="text-gray-600 mb-4">
              ...
              dictum et in feugiat nisl, tincidunt. Id laoreet suspendisse
              consequat gravida lacus, in amet. Amet quis est in diam. Nisi,
              amet aliquet pellentesque vitae. Adipiscing enim tristique morbi
              fermentum sed. Commodo arcu sed sed interdum volutpat. Ut auctor
              scelerisque pellentesque ac sed ultrices cursus et. Ullamcorper
              pellentesque et sit id in ornare semper ipsum a diam.
            </p>
            <p className="text-gray-600 mb-4">
              Vel dis a non amet a pellentesque. Lacinia nunc tortor, amet
              tempor feugiat. Sapien amet libero sit nulla pellentesque ut sit
              urna. Faucibus eget sed rhoncus ac. Lectus tincidunt pretium
              scelerisque molestie lectus varius at. Amet tincidunt elit quis
              neque, non eu nulla. Diam placerat lorem sagittis, non vel tempor.
              Vulputate porttitor suspendisse ultrices sodales sed at velit.
              Lorem sem ipsum erat tellus fusce eleifend nisi, nunc. Eleifend
              cursus adipiscing in dolor diam eu. Dignissim leo vel orci sit
              pulvinar.
            </p>
          </div>
